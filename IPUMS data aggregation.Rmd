...
clf <- filter(c1,EMPSTATD%in%c(100:120,140:240) & AGE%in%c(16:65)) %>%
...
unempl <- filter(c1,EMPSTATD%in%c(200:240) & AGE%in%c(16:65)) %>%
  group_by(COUNTRY,YEAR,GEOLEV1,GEOLEV2) %>%
  summarize(unempXX = sum(PERWT)) 
  
# Females 16 and over, not in armed forces (generally, employed or actively seeking employment)
lfpfemN <- filter(c1,SEX==2 & EMPSTATD%in%c(100:120,140) & AGE%in%c(16:65)) %>%
  group_by(COUNTRY,YEAR,GEOLEV1,GEOLEV2) %>%
  summarize(lfpfemNXX= sum(PERWT))
lfpfemD <- filter(c1,SEX==2 & EMPSTATD%in%c(100:120,140:240) & AGE%in%c(16:65)) %>%
  group_by(COUNTRY,YEAR,GEOLEV1,GEOLEV2) %>%
...
occagrN <- filter(c1,AGE%in%c(16:65) & EMPSTATD%in%c(100:120,140) & INDGEN==10%>%
  group_by(COUNTRY,YEAR,GEOLEV1,GEOLEV2) %>%
  summarize(occagrNXX = sum(PERWT)) 
occagrD <- filter(c1,AGE%in%c(16:65) & EMPSTATD%in%c(100:120,140) & !INDGEN%in%c(0,998:999)) %>%
  group_by(COUNTRY,YEAR,GEOLEV1,GEOLEV2) %>%
